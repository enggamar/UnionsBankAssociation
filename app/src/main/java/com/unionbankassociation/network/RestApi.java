...
import com.unionbankassociation.BuildConfig;
...
private static String mAuth = Credentials.basic("#@#@MyFiRsT@PrOjEcT#@#@", "#@##@iMpLeMeNTaTiOn@#@#");

    public static Retrofit sRetrofit, syncRetrofit;
